    ...
    <>
      ...
      <CommonForm onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col space-y-2">
          <h1 className="font-bold text-2xl">상품 생성</h1>
          <p className="font-light text-gray-400">다양한 예적금 상품을 만들어보세요.</p>
        </div>
        <Divider />
          ...
          <RadioSelect>
            ...
            <RadioContainer onClick={() => setValue("productType", "FIXED_DEPOSIT")}>
              ...
              <RadioTitleContainer>
                ...
                <RadioDescription>
                  매월 일정금액을 정기적으로 납입하고 만기일에 원리금을 지급받는 상품으로 푼돈을
                  모아 목돈을 마련하는데 가장 보편적인 장기저축 상품입니다.
                </RadioDescription>
              </RadioTitleContainer>
            </RadioContainer>
          </RadioSelect>

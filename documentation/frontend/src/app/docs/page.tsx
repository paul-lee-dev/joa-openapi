      ...
      <SubWrapper>
        <SidebarContainer>
          <SidebarWrapper>
            ...
            <BarItem onClick={() => handleItemClick(4)}>쿼리 스트링 명세</BarItem>
...
lg:mr-12 p-2 flex space-4 rounded-md 
hover:bg-slate-100 hover:text-purple-500 hover:font-bold
focus:bg-slate-100 focus:text-purple-500 focus:font-bold
cursor-pointer
`;

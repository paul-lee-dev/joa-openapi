...
public class DummyService {
    ...
    @Transactional
    public DummyResponseDto createMember(DummyUserRequestDto req, UUID bankId, UUID adminId) {
    ...
    @Transactional
    public DummyResponseDto createTransaction(DummyUserRequestDto req, UUID bankId, UUID adminId) {
